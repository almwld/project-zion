...
class _ZionDesktopState extends State<ZionDesktop> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _categories = [
    {"name": "attack".tr(), "icon": Icons.flash_on, "color": 0xFFFF5722},
    {"name": "defense".tr(), "icon": Icons.shield, "color": 0xFF4CAF50},
    {"name": "analysis".tr(), "icon": Icons.analytics, "color": 0xFF2196F3},
    {"name": "tools".tr(), "icon": Icons.build, "color": 0xFF9C27B0},
  ];
  ...
  final List<Map<String, dynamic>> _apps = [
    ...
    {"name": "SECURITY HUB", "icon": Icons.security, "category": "tools".tr(), "screen": const SecurityHubApp()},
    {"name": "TOOLS HUB", "icon": Icons.build, "category": "tools".tr(), "screen": const ToolsHubApp()},
    {"name": "PERF HUB", "icon": Icons.speed, "category": "tools".tr(), "screen": const PerformanceHubApp()},
    {"name": "DATA HUB", "icon": Icons.storage, "category": "tools".tr(), "screen": const DataHubApp()},
    ...
    {"name": "BATTERY", "icon": Icons.battery_charging_full, "category": "defense".tr(), "screen": const BatterySaverApp()},
    // ANALYSIS
    ...
    {"name": "CALCULATOR", "icon": Icons.calculate, "category": "analysis".tr(), "screen": const CalculatorApp()},
    {"name": "UNIT CONV", "icon": Icons.science, "category": "analysis".tr(), "screen": const UnitConverterApp()},
    {"name": "PERCENT", "icon": Icons.percent, "category": "analysis".tr(), "screen": const PercentageCalculatorApp()},
    {"name": "DATE CALC", "icon": Icons.calculate, "category": "analysis".tr(), "screen": const DateCalculatorApp()},
    {"name": "CURRENCY", "icon": Icons.attach_money, "category": "analysis".tr(), "screen": const CurrencyConverterApp()},
    {"name": "TRANSLATOR", "icon": Icons.translate, "category": "analysis".tr(), "screen": const TranslatorApp()},
  ];
